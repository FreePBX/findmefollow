...
if (isset($amp_conf["AMPEXTENSIONS"]) && ($amp_conf["AMPEXTENSIONS"] == "deviceanduser")) {
	$editURL = '?display=users&extdisplay='.ltrim((string) $request['extdisplay'],'GRP-') ;
	$EXTorUSER = _("User");
}else{
	$editURL = '?display=extensions&extdisplay='.ltrim((string) $request['extdisplay'],'GRP-') ;
...
<a href="<?php echo $editURL?>" class="btn btn-default"><i class="fa fa-external-link"></i>&nbsp; <?php echo $EXTorUSER . " " . ltrim((string) $request['extdisplay'],'GRP-') ?></a>
</div>
